...
Mit diesem Schlüssel haben wir einen SSH-Zugang auf dem Server. Wenn wir diesen Schlüssel in die Übungsumgebung kopieren, können wir uns mit ssh -i id_rsa walter@192.168.20.100 einloggen.
(image4)
